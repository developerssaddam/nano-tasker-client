...
const Features = () => {
  return (
    <div className="bg-[#EEF1F4] my-10 py-10 md:my-20 md:py-20">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
          <div className="features_card p-8 text-center shadow-xl bg-white rounded-xl">
            ...
            <div>
              ...
              <p className="text-gray-500">
                Participate in educational activities and challenges to collect
                coins, unlocking rewards and enhancing your learning experience.
              </p>
            </div>
          </div>
          ...
          <div className="features_card p-8 text-center shadow-xl bg-white rounded-xl">
            ...
            <div>
              <h2 className="text-2xl text-gray-700 mb-3">Secure Payments.</h2>
              <p className="text-gray-500">
