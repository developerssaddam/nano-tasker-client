...
const HowItWork = () => {
  return (
    <div className="my-10 py-10 md:my-20 md:py-20 how_it_works bg-fixed">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
          ...
          <div className="features_card p-8 text-center shadow-xl bg-white rounded-xl">
            ...
            <div>
              ...
              <p className="text-gray-500">
                Earn rewards on a unique micro-task completion website. Complete
                tasks, unlock opportunities, and reap the benefits of your
                skills and efforts.
              </p>
            </div>
          </div>
